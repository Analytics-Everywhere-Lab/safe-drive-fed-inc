...
model_path = ""
if args.if_fed == '0':
    model_path = os.path.join(os.getcwd(), "client3/saved_model/yolo-last.pt")
else:
    model_path = os.path.join(os.getcwd(), "client3/saved_model/yolo-avg.pt")
...
save_path = os.path.join(os.getcwd(), "client3/saved_model/yolo-last.pt")
model.ckpt = dict(model=model.model)
model.save(save_path)
print(f"Saved fine-tuned client3 model at: {save_path}")